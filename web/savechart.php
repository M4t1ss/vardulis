...
$aaa1 = "https://shot.screenshotapi.net/screenshot?token=J9VEY2Q-MTH4R5C-QNEF3FF-9R5QW49&url=https%3A%2F%2Fvardulis.lielakeda.lv%2Fchart.php&width=1100&height=600&fresh=true&output=image&file_type=png&wait_for_event=load";
	
echo "<img style='max-height:600px;max-width:46%;overflow: hidden;float:left;' src='".$aaa1."' >";
file_put_contents("/home/baumuin/public_html/vardulis/bildeVardulim.jpg", file_get_contents($aaa1));
// //Pirmā bilde
